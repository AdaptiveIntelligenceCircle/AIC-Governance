AIC-Governance — Trademark & International Protection Notice
Trademark Statement

"AIC-Governance" and its associated logos, designs, and system architectures are claimed as trademarks of the author (Nguyễn Đức Trí) as of their first public use and publication on this repository.
...
Any use of "AIC-Governance" or its derivative marks without prior written authorization may result in civil and/or criminal liability.
...
Use of the name "AIC-Governance" for academic reference, research citation, or fair commentary is permitted, provided it does not imply endorsement, ownership, or affiliation. Any commercial use requires explicit written permission from the author.
